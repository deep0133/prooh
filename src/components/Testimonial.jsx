...
const TestimonialSlider = () => {
  ...
  useGSAP(() => {
    ...
    gsap.to(characters, {
      ...
      duration: 0.2, // Animation duration per character
      ease: "power2.out",
      ...
      >
        <center>
          ...
          <h2 className='text-center font-bricolage mb-6'>
            <span className='text-[#232323] text-4xl sm:text-5xl font-bold capitalize leading-[51px]'>
              bringing the value across <br /> different{" "}
            </span>
            <span className='text-[#b8b8b8] text-4xl sm:text-5xl font-bold capitalize leading-[51px]'>
              brands
            </span>
          </h2>
        </center>
        ...
        {/* Testimonial Section */}
        <div className='card-with-shape z-50 content mx-auto col-span-full relative items-center gap-3 bg-white flex flex-col testimonial-shadow py-6'>
          <div className='absolute -top-2.5 sm:left-24 md:left-36 bg-white'>
            <img src={testimonialArrow} alt='' />
          </div>
          <div className='absolute z-0 opacity-70 top-2 left-[2%]'>
            <img src={quoteIcon} className='size-16 ' alt='Quote Icon' />
          </div>
          <p
            ref={textRef}
            className=' text-center z-10 relative px-[15%] sm:px-[10%] text-black text-2xl font-normal font-inter'
          >
...
const Card = ({ testimonial, index, activeIndex }) => {
  ...
  return (
    <div
      ref={cardRef}
      className={`flex-col flex-shrink-0 sm:m-0 m-2 font-bricolage cursor-pointer rounded-[46px] border-0 bg-neutral-50 flex justify-center items-center px-8 py-6`}
    >
      <img
        src={testimonial?.img}
