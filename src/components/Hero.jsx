...
//       data-bg='black'
//       data-color='white'
//       className='black-section z-10 relative min-h-svh w-full bg-black text-white pt-16'
//     >
...
//             <h2
//               ref={headingRef}
//               className='text-4xl sm:text-5xl flex gap-3 w-fit mx-auto md:text-7xl font-bold leading-[60px] md:leading-[89px] tracking-[-2px]'
//             >
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <FallingIcons icons={icons} />
      {/* Header */}
      <div className='flex sticky -mt-12 md:mt-0 md:bottom-0 gap-4  responsiveWidth justify-center items-center flex-col h-full'>
        {/* Notification Banner */}
        <div ref={notificationRef} className='flex justify-center'>
          <div className='bg-zinc-800/50 backdrop-blur-sm px-4 py-2 rounded-full inline-flex items-center gap-2'>
            <span className='text-amber-500'>🎉</span>
        ...
        {/* Main Content */}
        <main className='w-full font-bricolage text-center flex flex-col items-center'>
          <h2
            ref={headingRef}
            className='text-[9vw] tracking-normal leading-[13vw] text-center flex gap-3 md:text-7xl font-bold md:leading-[6vw]'
          >
            Welcome in Prooh <br /> AI Technologies
          </h2>
